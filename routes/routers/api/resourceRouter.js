...
router.post("/rename/[0-9]{10,}", auth.authInitialize, auth.tokenAuth, auth.serviceKeyAuth, auth.authFinalize, resourceControllers.renameResource);

router.post("/delete/[0-9]{10,}", auth.authInitialize, auth.tokenAuth, auth.serviceKeyAuth, auth.authFinalize, resourceControllers.deleteResource);
...
router.get("/download/[0-9]{10,}", auth.unforcedAuthInitialize, auth.tokenAuth, auth.serviceKeyAuth, auth.authFinalize, 
            resourceControllers.downloadResource);

router.get("/get/[0-9]{10,}", auth.unforcedAuthInitialize, auth.tokenAuth, auth.serviceKeyAuth, auth.authFinalize, 
